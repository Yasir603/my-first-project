...
import com.electrodragon.YasirFirstProject_admin.model.network.response.FetchUsersData
...
interface FetchUsersValidatorCallbacks {
...
class FetchUsersValidator {
    companion object {
        fun validate(
            response: Response<ElectroResponse<FetchUsersData>>,
            callbacks: FetchUsersValidatorCallbacks
        ) {
            when {
...
//                                        callbacks.onFetchUsersMilestoneCompleted(thing1, thing2)
//                                    }
                                }
                            }
                        }

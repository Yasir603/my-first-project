...
data class UpdateUserData (
        @SerializedName(ApiResponseConstant.EXCEPTIONS) val exceptions: UpdateUserResponseClasses.Exceptions?,
        @SerializedName("attribute_name") val attributeName: Boolean?
)

object UpdateUserResponseClasses {
    data class Exceptions( // <***_ELECTRO_GENERATED_DO_NOT_REMOVE_***>
        ...
        @SerializedName("failed_to_update") val failedToUpdate: Boolean?
